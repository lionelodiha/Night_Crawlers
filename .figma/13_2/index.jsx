    ...
    <div className={styles.home2}>
      <div className={styles.autoWrapper}>
        ...
        <div className={styles.heroSection1}>
          <p className={styles.everyDeliveryToYourD}>
      ...
      <div className={styles.heroSection2}>
        ...
        <div className={styles.heroSection2Inner1}>
          <div className={styles.heroSection2Inner2}>
            ...
            <p className={styles.nightCrawlersIsMoreT2}>
              Night Crawlers is more than a delivery app—we’re a platform built to
              elevate how people discover, enjoy, and experience food. We combine
              seamless technology with trusted restaurant partners to bring quality
              meals closer to you, no matter the hour.
      ...
      <div className={styles.heroSection5}>
        ...
        <div className={styles.hero4Content}>
          <p className={styles.redefiningConvenienc2}>
            Redefining Convenience, One Delivery at a Time.
          </p>
          <p className={styles.nightCrawlersIsMoreT3}>
            Night Crawlers is more than a delivery app—we’re a platform built to
            elevate how people discover, enjoy, and experience food. We combine
            seamless technology with trusted restaurant partners to bring quality
            meals closer to you, no matter the hour.
      ...
      <div className={styles.subscribeEmail}>
        <div className={styles.subscribeEmailInputC}>
          <p className={styles.exclusiveMenusPromot}>
          ...
          <div className={styles.links}>
            <div className={styles.aFooterLinksColumn}>
              ...
              <div className={styles.footerLinks}>
                <p className={styles.text2}>Overview</p>
                <p className={styles.text2}>Features</p>
              </div>
            </div>
            <div className={styles.aFooterLinksColumn}>
              <p className={styles.heading}>Company</p>
              <div className={styles.footerLinks}>
                <p className={styles.text2}>About us</p>
            ...
            <div className={styles.aFooterLinksColumn}>
              ...
              <div className={styles.footerLinks}>
                <p className={styles.text2}>Terms</p>
                <p className={styles.text2}>Privacy</p>
              </div>
            </div>
          </div>
        </div>
