...
const Explore: React.FC = () => {
  ...
  const handleSelectAddress = (address: string) => {
    // In a real app, this would update a global address state
  ...
  const stores = Array(4).fill(null).map(() => ({
    ...
    rating: 4.5,
    time: '10-15 mins',
    image: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?q=80&w=2070&auto=format&fit=crop' // Placeholder food image
  }));

  return (
    <div className="min-h-screen bg-[#F2F4F7] flex flex-col font-poppins relative overflow-x-hidden">
        <Header />
