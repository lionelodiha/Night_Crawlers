        ...
        return (
            <div className="min-h-screen bg-white flex items-center justify-center font-poppins">
                <div className="flex flex-col items-center gap-3">
                    <div className="w-8 h-8 border-2 border-dashed border-gray-300 rounded-full animate-spin border-t-[#C62222]"></div>
                    <p className="text-sm text-gray-500 font-medium">Loading console...</p>
                </div>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-white flex flex-col font-poppins relative">
            ...
            <header className="bg-white border-b border-gray-100 sticky top-0 z-30">
                <div className="max-w-[1400px] mx-auto px-4 md:px-6 h-16 md:h-20 flex items-center justify-between">
                    <div className="flex items-center gap-2 md:gap-3">
                        <div className="h-8 w-8 md:h-10 md:w-10 bg-black text-white rounded-xl flex items-center justify-center shadow-lg shadow-gray-200">
                            <ShieldAlert size={16} className="md:hidden" />
                            <ShieldAlert size={20} className="hidden md:block" />
                        </div>
                        <div>
                            <h1 className="font-bold text-gray-900 leading-none text-sm md:text-base">Admin Console</h1>
                            <span className="text-[8px] md:text-[10px] font-semibold text-gray-400 uppercase tracking-widest">Night Crawlers</span>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2 md:hidden">
                        <div className="text-right mr-1">
                            <p className="text-xs font-bold text-gray-900">{admin.username}</p>
                            <p className="text-[8px] text-green-600 font-medium">Online</p>
                        </div>
                        <div className="h-8 w-8 bg-gradient-to-br from-gray-800 to-black rounded-full flex items-center justify-center text-white text-[10px] font-bold">
                    ...
                    <div className="items-center gap-6 hidden md:flex">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-64 h-10 pl-9 pr-4 bg-gray-50 border border-gray-100 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-gray-100 transition-all font-medium"
                            />
                        </div>
                        ...
                        <div className="flex items-center gap-3">
                            <div className="text-right">
                                ...
                                <p className="text-[10px] text-green-600 font-medium bg-green-50 px-2 rounded-full inline-block">Online</p>
                            </div>
                            <div className="h-10 w-10 bg-gradient-to-br from-gray-800 to-black rounded-full flex items-center justify-center text-white text-xs font-bold border-2 border-white shadow-md">
                                {admin.username.substring(0, 2).toUpperCase()}
                            </div>
                        </div>
            ...
            <main className="flex-grow w-full max-w-[1400px] mx-auto px-4 md:px-6 py-6 md:py-10">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6 mb-6 md:mb-10">
                    ...
                    {/* Revenue Card */}
                    <div className="group bg-white p-4 md:p-6 rounded-xl md:rounded-2xl border border-gray-100 hover:border-gray-200 hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-all duration-300">
                        <div className="flex justify-between items-start mb-2 md:mb-4">
                            <div className="p-2 md:p-3 bg-green-50 text-green-600 rounded-lg md:rounded-xl group-hover:scale-110 transition-transform">
                                <TrendingUp size={18} className="md:hidden" />
                                <TrendingUp size={24} className="hidden md:block" />
                            </div>
                            <span className="text-[10px] md:text-xs font-semibold text-green-600 bg-green-50 px-1.5 md:px-2 py-0.5 md:py-1 rounded-md">+12.5%</span>
                        </div>
                    ...
                    <div className="group bg-white p-4 md:p-6 rounded-xl md:rounded-2xl border border-gray-100 hover:border-gray-200 hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-all duration-300">
                        <div className="flex justify-between items-start mb-2 md:mb-4">
                            <div className="p-2 md:p-3 bg-blue-50 text-blue-600 rounded-lg md:rounded-xl group-hover:scale-110 transition-transform">
                    ...
                    <div
                        ...
                        className="group bg-white p-4 md:p-6 rounded-xl md:rounded-2xl border border-gray-100 hover:border-orange-200 hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-all duration-300 cursor-pointer"
                    >
                        <div className="flex justify-between items-start mb-2 md:mb-4">
                            <div className="p-2 md:p-3 bg-orange-50 text-orange-600 rounded-lg md:rounded-xl group-hover:scale-110 transition-transform">
                                <Bike size={18} className="md:hidden" />
                                <Bike size={24} className="hidden md:block" />
                            </div>
                            {orderStats && (
                                <span className={`text-[10px] md:text-xs font-semibold px-1.5 md:px-2 py-0.5 md:py-1 rounded-md flex items-center gap-1 ${orderStats.onlineRiders > 0 ? 'text-green-600 bg-green-50' : 'text-gray-500 bg-gray-100'}`}>
                                    <span className={`w-1.5 h-1.5 rounded-full ${orderStats.onlineRiders > 0 ? 'bg-green-500 animate-pulse' : 'bg-gray-400'}`}></span>
                        ...
                        <p className="text-[10px] md:text-xs text-orange-500 mt-1 md:mt-2 opacity-0 group-hover:opacity-100 transition-opacity hidden md:block">Click to view all riders →</p>
                    </div>

                    {/* Orders Card - With Active Orders */}
                    <div className="group bg-white p-4 md:p-6 rounded-xl md:rounded-2xl border border-gray-100 hover:border-gray-200 hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-all duration-300">
                        <div className="flex justify-between items-start mb-2 md:mb-4">
                            <div className="p-2 md:p-3 bg-purple-50 text-purple-600 rounded-lg md:rounded-xl group-hover:scale-110 transition-transform">
                                <Package size={18} className="md:hidden" />
                                <Package size={24} className="hidden md:block" />
                            </div>
                            {orderStats && orderStats.activeOrders > 0 && (
                                <span className="text-[10px] md:text-xs font-semibold text-orange-600 bg-orange-50 px-1.5 md:px-2 py-0.5 md:py-1 rounded-md flex items-center gap-1">
                        ...
                        <div className="flex items-baseline gap-1 md:gap-2 mb-0.5 md:mb-1">
                            ...
                            {orderStats && orderStats.pendingOrders > 0 && (
                                <span className="text-[10px] md:text-sm font-medium text-yellow-600">({orderStats.pendingOrders})</span>
                            )}
                        </div>
                ...
                {orderStats && (orderStats.todayOrders > 0 || orderStats.activeOrders > 0) && (
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-4 mb-6 md:mb-10">
                        <div className="bg-gradient-to-br from-[#C62222] to-[#a01b1b] p-3 md:p-4 rounded-lg md:rounded-xl text-white">
                        ...
                        <div className="bg-gray-900 p-3 md:p-4 rounded-lg md:rounded-xl text-white">
                            <div className="flex items-center gap-1.5 md:gap-2 mb-1 md:mb-2">
                                ...
                                <span className="text-[10px] md:text-xs font-medium text-white/70">Pending</span>
                            </div>
                            <p className="text-lg md:text-2xl font-bold">{orderStats.pendingOrders}</p>
                            <p className="text-[10px] md:text-xs text-white/70">Awaiting</p>
                        </div>
                        <div className="bg-orange-500 p-3 md:p-4 rounded-lg md:rounded-xl text-white">
                            <div className="flex items-center gap-1.5 md:gap-2 mb-1 md:mb-2">
                        ...
                        <div className="bg-green-600 p-3 md:p-4 rounded-lg md:rounded-xl text-white">
                            <div className="flex items-center gap-1.5 md:gap-2 mb-1 md:mb-2">
                                <CheckCircle size={14} className="md:hidden" />
                                <CheckCircle size={16} className="hidden md:block" />
                                <span className="text-[10px] md:text-xs font-medium text-white/70">Done</span>
                            </div>
                            <p className="text-lg md:text-2xl font-bold">{orderStats.completedOrders}</p>
                            <p className="text-[10px] md:text-xs text-white/70">Delivered</p>
                        </div>
                    </div>
                )}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-8">
                            ...
                            {activity.length > 0 ? (
                                activity.map((item, i) => (
                                    <div key={i} className="flex gap-3 md:gap-4 relative">
                                        <div className={`w-8 h-8 md:w-10 md:h-10 rounded-full ${item.type === 'vendor' ? 'bg-blue-500' : item.type === 'rider' ? 'bg-orange-500' : 'bg-green-500'} flex items-center justify-center text-white shadow-sm flex-shrink-0 z-10 border-2 md:border-4 border-white`}>
                    ...
                    {/* Pending Actions */}
                    <div className="bg-gray-900 rounded-xl md:rounded-2xl p-4 md:p-6 text-white relative overflow-hidden flex flex-col">
                        <div className="absolute top-0 right-0 w-32 h-32 bg-gray-800 rounded-full blur-2xl opacity-50 -mr-10 -mt-10"></div>

                        <h3 className="font-bold text-base md:text-lg mb-1 relative z-10">Pending Actions</h3>
                        <p className="text-xs md:text-sm text-gray-400 mb-4 md:mb-6 relative z-10">Requires attention</p>
                            ...
                            {pending.length > 0 ? (
                                pending.map((item, i) => (
                                    <div
                                        ...
                                        className="bg-white/10 backdrop-blur-sm p-3 md:p-4 rounded-lg md:rounded-xl border border-white/5 hover:bg-white/15 transition-colors cursor-pointer group"
                                    >
                                        <div className="flex justify-between items-center">
                                            <span className="font-medium text-xs md:text-sm truncate flex-1">{item.title}</span>
                                            <div className={`w-2 h-2 rounded-full ${item.type === 'vendor' ? 'bg-red-500' : 'bg-orange-500'} group-hover:animate-pulse flex-shrink-0 ml-2`}></div>
                                        </div>
                                    </div>
                                ))
                            ) : (
                                <div className="bg-white/5 p-4 rounded-xl border border-white/5 text-center h-full flex flex-col items-center justify-center min-h-[120px] md:min-h-[150px]">
                                    <CheckCircle size={24} className="md:hidden mx-auto mb-2 text-green-500 opacity-80" />
                                    <CheckCircle size={32} className="hidden md:block mx-auto mb-3 text-green-500 opacity-80" />
                                    <span className="text-xs md:text-sm font-medium text-gray-300">All Clear</span>
                                    <span className="text-[10px] md:text-xs text-gray-500 mt-1">No pending approvals.</span>
                                </div>
                            )}
                        </div>
                    </div>
                    ...
                    <div className="bg-white w-full max-w-sm rounded-2xl shadow-2xl p-6 relative z-50 animate-in fade-in zoom-in-95 duration-200">
                        ...
                        <div className="flex gap-3">
                            ...
                            <button
                                ...
                                className="flex-1 py-3 px-4 bg-green-600 text-white font-bold rounded-xl hover:bg-green-700 transition-colors shadow-lg shadow-green-200 flex items-center justify-center gap-2"
                            >
                    ...
                    <div className="bg-white w-full max-w-2xl max-h-[80vh] rounded-2xl shadow-2xl relative z-50 animate-in fade-in zoom-in-95 duration-200 overflow-hidden flex flex-col">
                        <div className="p-6 border-b border-gray-100 flex justify-between items-center">
                            <div>
                                ...
                                <p className="text-sm text-gray-500 mt-1">{allRiders.length} riders registered • {onlineRiders.length} online</p>
                            </div>
                            <button
                            ...
                            {allRiders.length === 0 ? (
                                ...
                                <div className="space-y-3">
                                    {allRiders.map((rider) => (
                                        <div
                                            key={rider.id}
                                            className={`p-4 rounded-xl border ${rider.isOnline ? 'border-green-200 bg-green-50/50' : 'border-gray-100 bg-gray-50'} transition-all`}
                                        >
                                            <div className="flex items-center gap-4">
                                                <div className={`w-12 h-12 rounded-full flex items-center justify-center text-white font-bold ${rider.isOnline ? 'bg-green-500' : 'bg-gray-400'}`}>
