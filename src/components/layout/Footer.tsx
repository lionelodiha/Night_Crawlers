    ...
    <footer className="flex flex-col items-center bg-[#222222] w-full min-h-[272px] overflow-hidden pb-0">
      <div className="flex flex-col lg:flex-row items-start justify-between w-full max-w-[1467px] mt-[-23px] px-4 sm:px-6 md:px-[26px] lg:px-[26px] xl:pr-[48px]">
        <div className="relative w-full lg:w-[281px] h-[182px] mb-8 lg:mb-0">
          ...
          />
          <p className="absolute top-[120px] sm:top-[130px] md:top-[135px] lg:top-[139px] left-[16px] w-[calc(100%-32px)] sm:w-[240px] md:w-[254px] lg:w-[268px] h-[40px] text-[14px] leading-[20px] tracking-normal text-white font-poppins m-0">
            Get your favorite meals delivered fast, fresh, and right to your door.
          </p>
        </div>

        <div className="flex flex-col sm:flex-row items-start gap-8 sm:gap-12 md:gap-16 lg:gap-[32px] mt-0 lg:mt-[56px] w-full lg:w-[681px]">
